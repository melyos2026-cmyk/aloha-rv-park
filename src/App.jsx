...
const LOTS = {
  ...
  A9: [7.7, 22.2, 4.1, 5.7],
  A11: [11.8, 22.2, 4.2, 5.7],
  A13: [16.0, 22.3, 4.1, 5.7],
  A15: [20.1, 22.3, 4.2, 5.7],
  A17: [24.2, 22.4, 4.1, 5.7],
  A19: [28.3, 22.4, 4.2, 5.7],
  A21: [32.5, 22.5, 4.2, 5.6],
  A23: [36.7, 22.5, 4.1, 5.6],
  A25: [40.8, 22.6, 4.0, 5.5],
  A27: [44.8, 22.6, 4.1, 5.5],
  A29: [48.9, 22.7, 4.2, 5.5],
  A31: [53.1, 22.7, 4.2, 5.5],
  ...
  B10: [63.9, 48.9, 5.4, 2.7],
  B11: [63.9, 51.6, 5.4, 2.7],
  B12: [63.8, 57.7, 5.4, 2.4],
  B13: [63.8, 60.1, 5.4, 2.4],
  B14: [63.8, 62.4, 5.4, 2.4],
  ...
  D3: [73.7, 45.4, 4.2, 2.9],
  D5: [73.7, 42.5, 4.2, 2.9],
  D7: [73.7, 39.6, 4.2, 2.9],
  D9: [73.7, 36.8, 4.2, 2.8],
  D11: [73.7, 33.8, 4.2, 3.0],
  D13: [73.7, 31.1, 4.2, 2.7],
  D15: [73.7, 28.1, 4.2, 3.0],
  D17: [73.7, 24.9, 4.2, 3.2],
  ...
  D19: [78.3, 24.9, 4.3, 2.9],
  D20: [86.4, 13.8, 5.2, 3.6],
  S2: [86.9, 58.3, 4.3, 2.7],
  S3: [82.3, 60.9, 4.7, 2.6],
  S4: [86.9, 60.9, 4.3, 2.6],
  S5: [82.3, 63.4, 4.7, 2.6],
  S6: [86.9, 63.4, 4.3, 2.6],
  S1: [82.2, 58.4, 4.7, 2.6],
};
